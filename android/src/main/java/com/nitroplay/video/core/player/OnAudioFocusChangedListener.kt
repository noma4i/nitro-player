...
import com.margelo.nitro.video.HybridNitroPlayerEventEmitter
...
class OnAudioFocusChangedListener : AudioManager.OnAudioFocusChangeListener {
  private var eventEmitter: HybridNitroPlayerEventEmitter? = null
  ...
  fun setEventEmitter(eventEmitter: HybridNitroPlayerEventEmitter) {
