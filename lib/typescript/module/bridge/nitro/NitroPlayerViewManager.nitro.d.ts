...
import type { ResizeMode } from '../../view/types/ResizeMode';
...
export interface NitroPlayerViewManager extends HybridObject<{
    ios: 'swift';
    android: 'kotlin';
}> {
    player?: NitroPlayer;
    ...
    addOnFullscreenChangeListener(listener: (fullscreen: boolean) => void): ListenerSubscription;
...
export interface NitroPlayerViewManagerFactory extends HybridObject<{
    ios: 'swift';
    android: 'kotlin';
}> {
    createViewManager(nitroId: number): NitroPlayerViewManager;
}
//# sourceMappingURL=NitroPlayerViewManager.nitro.d.ts.map