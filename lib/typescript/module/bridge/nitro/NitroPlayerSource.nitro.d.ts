 ...
 */
export interface NitroPlayerSource extends HybridObject<{
    ios: 'swift';
    android: 'kotlin';
}>, NitroPlayerSourceBase {
}
export interface NitroPlayerSourceFactory extends HybridObject<{
    ios: 'swift';
    android: 'kotlin';
}> {
...
//# sourceMappingURL=NitroPlayerSource.nitro.d.ts.map