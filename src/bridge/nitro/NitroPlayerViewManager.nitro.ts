...
// @internal
export interface NitroPlayerViewManager extends HybridObject<{ ios: 'swift'; android: 'kotlin' }> {
  player?: NitroPlayer;
  isAttached: boolean;
  controls: boolean;
...
// @internal
export interface NitroPlayerViewManagerFactory extends HybridObject<{ ios: 'swift'; android: 'kotlin' }> {
