...
namespace margelo::nitro::video {
  ...
  /**
   * A struct which can be represented as a JavaScript object (NitroSourceMetadata).
   */
  struct NitroSourceMetadata final {
  public:
  ...
  public:
    NitroSourceMetadata() = default;
    explicit NitroSourceMetadata(std::optional<std::string> title, std::optional<std::string> subtitle, std::optional<std::string> description, std::optional<std::string> artist, std::optional<std::string> imageUri): title(title), subtitle(subtitle), description(description), artist(artist), imageUri(imageUri) {}

  public:
    friend bool operator==(const NitroSourceMetadata& lhs, const NitroSourceMetadata& rhs) = default;
  };
...
namespace margelo::nitro {
  ...
  // C++ NitroSourceMetadata <> JS NitroSourceMetadata (object)
  template <>
  struct JSIConverter<margelo::nitro::video::NitroSourceMetadata> final {
    static inline margelo::nitro::video::NitroSourceMetadata fromJSI(jsi::Runtime& runtime, const jsi::Value& arg) {
      jsi::Object obj = arg.asObject(runtime);
      return margelo::nitro::video::NitroSourceMetadata(
    ...
    static inline jsi::Value toJSI(jsi::Runtime& runtime, const margelo::nitro::video::NitroSourceMetadata& arg) {
