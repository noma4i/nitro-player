...
namespace margelo::nitro::video {
  ...
  /**
   * The C++ JNI bridge between the C++ struct "NitroSourceMetadata" and the the Kotlin data class "NitroSourceMetadata".
   */
  struct JNitroSourceMetadata final: public jni::JavaClass<JNitroSourceMetadata> {
  public:
    static constexpr auto kJavaDescriptor = "Lcom/margelo/nitro/video/NitroSourceMetadata;";

  public:
    /**
     * Convert this Java/Kotlin-based struct to the C++ struct NitroSourceMetadata by copying all values to C++.
     */
    [[maybe_unused]]
    [[nodiscard]]
    NitroSourceMetadata toCpp() const {
  ...
  public:
     ...
     */
    [[maybe_unused]]
    static jni::local_ref<JNitroSourceMetadata::javaobject> fromCpp(const NitroSourceMetadata& value) {
      using JSignature = JNitroSourceMetadata(jni::alias_ref<jni::JString>, jni::alias_ref<jni::JString>, jni::alias_ref<jni::JString>, jni::alias_ref<jni::JString>, jni::alias_ref<jni::JString>);
      static const auto clazz = javaClassStatic();
