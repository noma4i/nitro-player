...
/**
 * Represents an instance of `NitroSourceMetadata`, backed by a C++ struct.
 */
public typealias NitroSourceMetadata = margelo.nitro.video.NitroSourceMetadata

public extension NitroSourceMetadata {
  private typealias bridge = margelo.nitro.video.bridge.swift

  /**
   * Create a new instance of `NitroSourceMetadata`.
   */
