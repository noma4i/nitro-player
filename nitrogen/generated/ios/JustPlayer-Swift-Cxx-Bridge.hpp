///
/// JustPlayer-Swift-Cxx-Bridge.hpp
...
namespace JustPlayer { class HybridVideoPlayerSourceFactorySpec_cxx; }
...
namespace JustPlayer { class HybridVideoViewViewManagerFactorySpec_cxx; }
// Forward declaration of `HybridVideoViewViewManagerSpec_cxx` to properly resolve imports.
namespace JustPlayer { class HybridVideoViewViewManagerSpec_cxx; }
