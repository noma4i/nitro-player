///
/// JustPlayer-Swift-Cxx-Umbrella.hpp
...
#if __has_include("JustPlayer-Swift.h")
// This header is generated by Xcode/Swift on every app build.
// If it cannot be found, make sure the Swift module's name (= podspec name) is actually "JustPlayer".
#include "JustPlayer-Swift.h"
// Same as above, but used when building with frameworks (`use_frameworks`)
#elif __has_include(<JustPlayer/JustPlayer-Swift.h>)
#include <JustPlayer/JustPlayer-Swift.h>
#else
#error JustPlayer's autogenerated Swift header cannot be found! Make sure the Swift module's name (= podspec name) is actually "JustPlayer", and try building the app first.
#endif
