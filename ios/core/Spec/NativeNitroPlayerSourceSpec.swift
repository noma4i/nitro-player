//
//  NativeNitroPlayerSourceSpec.swift
//  nitro-play
//
...
public typealias NativeNitroPlayerSource = NativeNitroPlayerSourceSpec & HybridNitroPlayerSourceSpec

public protocol NativeNitroPlayerSourceSpec {
  // MARK: - Properties
