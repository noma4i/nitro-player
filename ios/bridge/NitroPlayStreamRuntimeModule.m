...
@interface RCT_EXTERN_MODULE(NitroPlayStreamRuntime, NSObject)
...
RCT_EXTERN_METHOD(clearPreview:(RCTPromiseResolveBlock)resolver rejecter:(RCTPromiseRejectBlock)rejecter)
